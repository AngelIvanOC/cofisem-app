// ============================================================
// src/features/ajustador/ListaSiniestros.jsx  — mobile scroll fix
// ============================================================
...
export default function ListaSiniestros({ onAtender }) {
  ...
  return (
    // flex-col h-full: ocupa todo el espacio disponible sin romper el layout
    <div className="flex flex-col h-full min-h-0">
      ...
      {/* Lista scrolleable — el truco: overflow-y-auto en este div */}
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3">
        ...
        {/* Espaciado extra al fondo para no quedar tapado */}
        <div className="h-4" />
      </div>
    </div>
  );
