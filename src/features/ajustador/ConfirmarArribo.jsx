...
// Bloque normal — fluye dentro del flex-1 overflow-y-auto del padre (PanelDetalle)
// El botón está al final del contenido — aparece al scrollear
// ============================================================
    ...
    <div className="px-4 py-4 space-y-4">
      ...
      >
        <div className="flex items-center gap-3">
          <div
            className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-all ${confirmado ? "bg-emerald-500" : "bg-gray-200"}`}
          >
            {confirmado ? (
              <svg
          ...
          <div>
            <p
              className={`text-sm font-bold ${confirmado ? "text-emerald-700" : "text-gray-600"}`}
            >
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="bg-gray-50 rounded-xl p-3">
            ...
            <p className="text-xs font-semibold text-[#13193a] mt-0.5 truncate">
              {siniestro.poliza}
            </p>
          </div>
        </div>
      ...
      {/* Botón al final del contenido — no sticky, aparece naturalmente al scrollear */}
