      ...
      >
        ...
        <div className="p-6">
          ...
          <input
            ...
            className="w-full px-3 py-2.5 rounded-xl border border-gray-200 bg-white text-sm text-gray-700 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#13193a]/15 focus:border-[#13193a] transition-all mb-3"
          />
        ...
        <div className="flex gap-3 px-6 pb-6">
          ...
          <button
            onClick={() => {
              if (val.trim()) onGuardar(val.trim());
            }}
            disabled={!val.trim()}
