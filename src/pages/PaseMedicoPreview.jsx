...
// Acceso: /gaman/pase-medico-preview?id=35  (ruta pública, sin autenticación)
// Escribe el id del siniestro (columna "id" de la tabla siniestros)
// y se renderiza el PDF del Pase Médico tal como se descargaría.
...
export default function PaseMedicoPreview() {
  ...
  useEffect(() => {
    ...
    setError(null);
    setData(null);
    fetchPaseMedicoData(Number(id))
      .then((raw) => setData(buildPaseMedicoPDF(raw)))
