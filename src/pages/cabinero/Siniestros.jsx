// ============================================================
// src/pages/cabinero/Siniestros.jsx
// Cabinero: Lista de siniestros + modal detalle
// ETAPA 2: Agregada acción "Asignar ajustador" (spec: Ver y asignar)
// ============================================================
...
// ── Panel de asignación de ajustador ─────────────────────────
...
function ModalDetalle({ s, onClose, onAsignar }) {
  const [modoAsignar, setModoAsignar] = useState(!s.ajustador); // abre automático si no tiene
