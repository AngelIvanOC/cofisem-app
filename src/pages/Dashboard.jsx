// TODO: Implementar página Dashboard
export default function Dashboard({ rolNombre, usuario }) {
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-[#13193a]">Dashboard</h1>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 flex flex-col items-center justify-center text-center gap-3">
        ...
        <p className="text-gray-400 text-sm">Próximamente: <strong className="text-gray-600">Dashboard</strong></p>
      </div>
    </div>
  );
}
