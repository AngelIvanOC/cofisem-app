...
const OperadorDashboard = lazy(
  () => import("./pages/operador/OperadorDashboard"),
);
...
const OperadorVendedores = lazy(() =>
  import("./pages/operador/Vendedores").then((m) => ({
    default: m.Vendedores,
  })),
);
...
const AdminDashboard = lazy(
  () => import("./pages/administracion/AdminDashboard"),
);
...
const AdminUsuarios = lazy(
  () => import("./pages/administracion/AdminUsuarios"),
);
const AdminConfiguracion = lazy(
  () => import("./pages/administracion/AdminConfiguracion"),
);
const AdminEstadoCuenta = lazy(
  () => import("./pages/administracion/EstadoDeCuenta"),
);
...
const CabineroDashboard = lazy(
  () => import("./pages/cabinero/CabineroDashboard"),
);
...
const AjustadorSiniestros = lazy(
  () => import("./pages/ajustador/AjustadorSiniestros"),
);
...
const SupervisorSiniestros = lazy(
  () => import("./pages/supervisor/SupervisorSiniestros"),
);
const SupervisorAjustadores = lazy(
  () => import("./pages/supervisor/SupervisorAjustadores"),
);
const SupervisorReportes = lazy(
  () => import("./pages/supervisor/SupervisorReportes"),
);
const SupervisorCostos = lazy(
  () => import("./features/supervisor/SupervisorCostos"),
);
...
const VentasCotizaciones = lazy(
  () => import("./pages/ventas/VentasCotizaciones"),
);
...
function PagosRoute({ rolNombre, usuario }) {
  switch (rolNombre) {
    case "OPERADOR":
      return <OperadorPagos usuario={usuario} />;
    case "ANALISTA":
      return <AnalistaPagos usuario={usuario} />;
    case "ADMINISTRACION":
      return <AdminPagos usuario={usuario} />;
    default:
...
function VencimientosRoute({ rolNombre, usuario }) {
  switch (rolNombre) {
    case "OPERADOR":
      return <Vencimientos usuario={usuario} soloOficina />;
    case "ANALISTA":
    case "ADMINISTRACION":
      return <Vencimientos usuario={usuario} />;
    default:
      return <PaginaEnConstruccion titulo="Vencimientos" />;
  }
}
...
function SiniestrosRoute({ rolNombre, usuario }) {
  switch (rolNombre) {
    case "CABINERO_SINIESTROS":
      return <Siniestros usuario={usuario} />;
    case "AJUSTADOR":
      return <AjustadorSiniestros />;
    case "SUPERVISOR_SINIESTROS":
      return <SupervisorSiniestros />;
    default:
      return <Navigate to="/gaman/dashboard" replace />;
  }
}
    ...
    <BrowserRouter>
      <Suspense fallback={<Spinner />}>
        <Routes>
          ...
          <Route
            path="/gaman/pase-taller-preview"
            element={<PaseTallerPreview />}
          />
          <Route
            path="/gaman/pase-medico-preview"
            element={<PaseMedicoPreview />}
          />
          <Route
          ...
          {/* ── Verificación pública de pólizas ── */}
          <Route
            path="/gaman/verificar/:constancia"
          ...
          <Route element={<CofisemLayout />}>
            <Route
              path="/accesos"
              element={
                ["AJUSTADOR", "SUPERVISOR_SINIESTROS"].includes(rolNombre) ? (
          ...
          {session && rolNombre ? (
            ...
            >
              ...
              <Route
                path="/gaman/*"
                element={<Navigate to="/gaman/dashboard" replace />}
              />
            </Route>
          ) : (
            <>
